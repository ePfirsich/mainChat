...
if($wo_online == "chat") {
	...
	$text .= " | <a href=\"inhalt.php?seite=raum&id=$id\" target=\"chat\" title=\"" . $t['navigation_raeume'] . "\"><span class=\"fa fa-road icon16\"></span> <span>" . $t['navigation_raeume'] . "</span></a>&nbsp;|&nbsp;";
}
$text .= "<a href=\"inhalt.php?seite=benutzer&id=$id\" target=\"chat\" title=\"" . $t['navigation_benutzer'] . "\"><span class=\"fa fa-user icon16\"></span> <span>" . $t['navigation_benutzer'] . "</span></a>&nbsp;";
if ($u_level != 'G') {
	$text .= " | <a href=\"inhalt.php?seite=nachrichten&id=$id\" target=\"chat\" title=\"" . $t['navigation_nachrichten'] . "\"><span class=\"fa fa-envelope icon16\"></span> <span>" . $t['navigation_nachrichten'] . $neue_nachrichten . "</span></a>&nbsp;";
}
if($wo_online == "forum") {
...
$text .= " | <a href=\"inhalt.php?seite=einstellungen&id=$id\" target=\"chat\" title=\"" . $t['navigation_einstellungen'] . "\"><span class=\"fa fa-cog icon16\"></span> <span>" . $t['navigation_einstellungen'] . "</span></a>&nbsp;";
$text .= " | <a href=\"inhalt.php?seite=profil&id=$id\" target=\"chat\" title=\"" . $t['navigation_profil'] . "\"><span class=\"fa fa-user-circle-o icon16\"></span> <span>" . $t['navigation_profil'] . "</span></a>&nbsp;";
if ($u_level != 'G') {
	$text .= " | <a href=\"inhalt.php?seite=freunde&id=$id\" target=\"chat\" title=\"" . $t['navigation_freunde'] . "\"><span class=\"fa fa-users icon16\"></span> <span>" . $t['navigation_freunde'] . "</span></a>&nbsp;";
}
if ($admin) {
	$text .= " | <a href=\"inhalt.php?seite=sperren&id=$id\" target=\"chat\" title=\"" . $t['navigation_sperren'] . "\"><span class=\"fa fa-lock icon16\"></span> <span>" . $t['navigation_sperren'] . "</span></a>&nbsp;";
	$text .= " | <a href=\"inhalt.php?seite=statistik&id=$id\" target=\"chat\" title=\"" . $t['navigation_statistik'] . "\"><span class=\"fa fa-bar-chart icon16\"></span> <span>" . $t['navigation_statistik'] . "</span></a>&nbsp;";
}
...
if ($wo_online == "chat") {
	$text .= " | <a href=\"inhalt.php?seite=log&id=$id&back=500\" target=\"_blank\" title=\"" . $t['navigation_log'] . "\"><span class=\"fa fa-archive icon16\"></span> <span>" . $t['navigation_log'] . "</span></a>&nbsp;";
}
$text .= " | <a href=\"inhalt.php?seite=hilfe&id=$id\" target=\"chat\" title=\"" . $t['navigation_hilfe'] . "\"><span class=\"fa fa-question icon16\"></span> <span>" . $t['navigation_hilfe'] . "</span></a>&nbsp;";
$text .= " | <a href=\"index.php?id=$id&aktion=logoff\" target=\"_top\" title=\"" . $t['navigation_logout'] . "\"><span class=\"fa fa-sign-out icon16\"></span> <span>" . $t['navigation_logout'] . "</span></a>";
