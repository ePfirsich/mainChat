...
switch ($aktion) {
	...
	// Formular ausgeben
		if ($u_level == "S") {
			...
			$box = $t['sonst45'];
			$text = "<form name=\"userimport2\" enctype=\"multipart/form-data\" action=\"inhalt.php?seite=benutzer\" method=\"post\">\n"
	...
	// Benutzer Löschen
		if ($u_level == "S") {
			...
			$box = $t['sonst51'];
			$text = $f1 . $t['sonst49'] . " <a href=\"inhalt.php?seite=benutzer&id=$id&aktion=userloeschen2\">[" . $t['sonst50'] . "]</a>" . $f2;
