...
$t['freunde_fehlermeldung_gast'] = "Der Benutzer '%nickname%' kann nicht als Freund hinzugefügt werden, da dieser Benutzer ein Gast ist!<br>";
...
$t['mail4'] = "<br> Eine Nachricht aus dem $chat " . $chat_url;
