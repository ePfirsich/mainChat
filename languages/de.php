...
$lang['ignore1'] = "<b>$chat:</b> Benutzer '%i_user_name_passiv%' wird ab jetzt ignoriert.";
$lang['ignore2'] = "<b>$chat:</b> Benutzer '%i_user_name_passiv%' wird von Benutzer '%i_user_name_aktiv%' ab jetzt ignoriert.";
$lang['ignore3'] = "<b>$chat:</b> Benutzer '%i_user_name_passiv%' wird nicht länger ignoriert.";
$lang['ignore4'] = "<b>$chat:</b> Benutzer '%i_user_name_passiv%' wird von Benutzer '%i_user_name_aktiv%' nicht mehr ignoriert.";
$lang['ignore5'] = "<b>$chat:</b> Der Benutzer '%i_user_name_passiv%' ist Admin und kann nicht ignoriert werden!";
...
$lang['raum_gehe2'] = "<b>$chat:</b> Zur Info: Sie sind aus %r_name_neu% ausgesperrt.";
$lang['raum_gehe3'] = "Eintrittsnachricht";
$lang['raum_gehe4'] = "<b>$chat:</b> Raum %r_name_neu% kann nicht betreten werden!";
$lang['raum_gehe5'] = "<b>$chat:</b> Sie sind leider aus %r_name_neu% ausgesperrt.";
$lang['raum_gehe6'] = "Topic";
$lang['raum_gehe7'] = "<b>$chat:</b> Sie haben leider zu wenig Punkte (mind. %r_min_punkte% nötig) um Raum %r_name_neu% zu betreten.";
$lang['raum_gehe8'] = "<b>$chat:</b> Als Gast können Sie den Raum %r_name_neu% nicht betreten, da hierzu Punkte notwendig sind, die Sie als Gast nicht bekommen können. Melden Sie sich hierzu an.";
...
$lang['chat_msg9'] = "<b>$chat:</b> Benutzer '%u_nick%' ignoriert niemanden.";
$lang['chat_msg10'] = "<b>$chat:</b> '%u_nick%' ignoriert ";
...
$lang['chat_msg13'] = "<b>$chat:</b> Der Benutzer '%s_user_name%' ist ein Admin und es ist nicht nett, Admins zu kicken!";
...
$lang['chat_msg21'] = "<b>$chat:</b> <span style=\"color:#%u_farbe%;\">Neue Farbe ist '%u_farbe%'.</span>";
$lang['chat_msg22'] = "<b>$chat:</b> Aktuelle Farbe ist '%u_farbe%'.";
...
$lang['chat_msg32'] = "<b>$chat:</b> Benutzername wurde nicht ergänzt: <b>%nickkurz%</b> ist nicht eindeutig, im Chat sind: ";
$lang['chat_msg33'] = "<b>$chat:</b> Bitte geben Sie für die Suche mit /whois mindestens 3 Buchstaben ein (% ist Joker).";
$lang['chat_msg34'] = "<b>%user%</b> packt den Würfelbecher und wirft mit %wuerfel%: ";
$lang['chat_msg35'] = "<b>$chat:</b> Beispiel: <b>/dice 3W6</b> wirft drei sechsseitige Würfel.";
...
$lang['chat_msg42'] = "<b>$chat:</b> Benutzername wurde nicht ergänzt: <b>%nickkurz%</b> ist nicht eindeutig, online in diesem Raum sind: ";
$lang['chat_msg43'] = "<b>$chat:</b> Benutzername wurde nicht ergänzt: <b>%nickkurz%</b> ist nicht eindeutig, im Chat existieren: ";
$lang['chat_msg44'] = "<b>Fehler:</b> Benutzer '%chatzeile%' ist nicht in diesem Raum!";
$lang['chat_msg45'] = "<b>$chat:</b> alle doppelten IPs wurden gelistet.";
$lang['chat_msg46'] = "<b>$chat:</b> keine doppelten IPs gefunden.";
$lang['chat_msg47'] = "<b>$chat:</b> Die Nachricht wurde an die Admins weitergeleitet.";
$lang['chat_msg48'] = "<b>$chat:</b> Die Nachricht konnte nicht weitergeleitet werden: kein Admin im Chat :-(";
$lang['chat_msg49'] = "<b>$chat: Benutzer %user% aus Raum %raum% ruft um Hilfe:</b>";
$lang['chat_msg50'] = "alle Admins";
$lang['chat_msg51'] = "CHAT-Admins";
$lang['chat_msg52'] = "an";
$lang['chat_msg53'] = "Der Raum '%raumname%' existiert nicht.";
$lang['chat_msg54'] = "<b>$chat:</b> Bitte nicht mehr als $smilies_anzahl Grafiken auswählen.";
...
$lang['chat_msg77'] = "<b>$chat:</b> Die Nachricht '%nachricht%' wurde nicht zugestellt.";
$lang['chat_msg78'] = "flüstert an alle";
$lang['chat_msg79'] = "<b>Fehler:</b> Es ist kein anderer Benutzer online.";
$lang['chat_msg82'] = "<b>$chat:</b> '%u_nick%' wird von folgenden Benutzern ignoriert: ";
$lang['chat_msg90'] = "<b>$chat:</b> %u_nick% ist online im %raum%";
...
$lang['chat_msg101'] = "<b>$chat:</b> Sie werden nach %zeit% Minuten automatisch aus dem $chat ausgeloggt, wenn Sie nichts schreiben!";
...
$lang['knebel5'] = "<b>$chat:</b> Der Benutzer '%admin%' ist ein Admin und es gehört sich nicht, Admins zu knebeln.";
$lang['knebel6'] = "<b>$chat:</b> Du bist vor Schreck noch %zeit% sprachlos.";
$lang['knebel7'] = "<b>$chat:</b> Du verschluckst Dich und bist vor Schreck sprachlos.";
$lang['knebel8'] = "<b>$chat:</b> %user% wurde im Raum %raum% geknebelt <b>(Autoknebel)</b>.";
$lang['knebel9'] = "<b>$chat:</b> Text:";
$lang['knebel10'] = "<b>$chat:</b> Private Textnachricht - Knebelgrund:";
...
$lang['invite5'] = "<b>$chat:</b> '%admin%' hat Sie in den Raum '%raum%' eingeladen. Mit '<b>/raum %raum%</b>' gelangen Sie dorthin. Wenn Sie 60 Sekunden warten, können Sie über die <b>Raumauswahl</b> (Anderen Raum betreten) in den Raum wechseln.";
$lang['invite6'] = "<b>$chat:</b> Eine Beraterin läd Sie in das %raum% ein. Dort können Sie ein persönliches Beratungsgespräch unter vier Augen führen.<br><br>Mit '<b>/raum %raum%</b>' gelangen Sie dorthin. Wenn Sie 60 Sekunden warten, können Sie über die <b>Raumauswahl</b> (Anderen Raum betreten) in den Raum wechseln.";

$lang['moderiert1'] = "<b>$chat:</b> Diese Funktion ist einem moderierten Raum nicht verfügbar, wenn ein Moderator anwesend ist.";
$lang['moderiert2'] = "<b>$chat:</b> Ihre Eingabe wurde an den Moderator weitergeleitet.";

$lang['moderiertdel1'] = "<b>$chat:</b> Ihre Eingabe wurde vom Moderator gelöscht: Diese Frage wurde (sinngemäß) bereits gestellt.";
$lang['moderiertdel2'] = "<b>$chat:</b> Ihre Eingabe wurde vom Moderator gelöscht: Bitte freundlicher formulieren.";
$lang['moderiertdel3'] = "<b>$chat:</b> Ihre Eingabe wurde vom Moderator gelöscht: Wir können leider nicht alle Fragen in der kurzen Zeit beantworten.";
$lang['moderiertdel4'] = "<b>$chat:</b> Ihre Eingabe wurde vom Moderator gelöscht.";

$lang['profil1'] = "<b>$chat:</b> Sie haben Ihr <a %link%>Profil</a> noch nicht ausgefüllt! Bitte klicken Sie &gt&gt<a %link%>HIER</a>&lt&lt";

$lang['chatmsg_mail1'] = "<b>$chat:</b> Sie haben neue Nachrichten. <a %link%>Gleich lesen?</a>";
$lang['chatmsg_mail2'] = " Nachricht von '%nick%' am %zeit%: %betreff%";
$lang['chatmsg_freunde1'] = "<b>$chat:</b> Ein Freund ist da: %u_nick% betritt Raum %raum%";
$lang['chatmsg_freunde2'] = "<b>$chat:</b> Ein Freund geht weg: %u_nick% verlässt den Chat";
