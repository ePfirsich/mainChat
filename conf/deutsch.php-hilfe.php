...
$hilfe_uebersichtstext = "<p><b>Erste Hilfe bei Problemen:</b><br>"
	...
	. "<p><b>Befehle:</b><br>"
	. "Die meisten Einstellungen können durch <a href=\"hilfe.php?id=$id&aktion=befehle\">"
	. "<b>Befehle im Chat</b></A> oder direkt im "
	. "Fenster (<a href=\"edit.php?id=$id\"><b>Einstellungen</b></A>, "
	. "<a href=\"raum.php?id=$id\"><b>Räume</b></A>) verändert werden. Für die voreingestellten Sprüche, "
	. "die im Chat abgerufen werden können, gibt es noch eine <a href=\"hilfe.php?id=$id&aktion=sprueche\">"
	. "<b>Übersicht</b></A>.</p>" . "<p><b>Liste:</b><br>"
	. "Im Chat, wie auch im Fenster (<a href=\"edit.php?id=$id\"><b>Benutzerliste</b></A>), "
	...
	. "<p><b><a href=\"smilies.php?id=$id\" target=\"userliste\">Smileys-Liste</A>"
...
Benutzer, die gegen die Nutzungsbestimmungen verstoßen, zu identifizieren, aus dem Chat zu
...
Passwort lesen. Die Admin können allerdings die Passwörter der Benutzer auf
