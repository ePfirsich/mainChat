...
if ($u_id) {
	...
	if ($o_js) {
		$text .= " | <a href=\"reset.php?id=" . $id . "\"&reset=1&forum=1\" onMouseOver=\"return(true)\" onClick=\"neuesFenster('reset.php?id=" . $id . "&reset=1&forum=1');return(false)\" title=\"" . $t['menue13'] . "\"><span class=\"fa fa-refresh icon16\"></span> <span>" . $t['menue13'] . "</span></a>&nbsp;";
	}
